  ...
  return (
    ...
    >
      <div className="px-6 mb-8">
        <Link
          href="/"
          className="font-heading text-heading font-semibold text-primary flex items-center gap-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          ...
          {open && (
            <div className="mt-1 ml-9 space-y-1 border-l border-outline-variant/40 pl-3">
                ...
                projects.map((p) => {
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        "py-1 text-caption flex items-center gap-2 transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
              ...
              <Link
                ...
                className="py-1 text-primary text-caption font-semibold flex items-center gap-1 hover:underline rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              >
