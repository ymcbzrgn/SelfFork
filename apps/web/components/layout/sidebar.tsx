  ...
  return (
    ...
    >
      <div className="px-6 mb-8">
        <Link
          href="/"
          className="font-heading text-heading font-semibold text-primary flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-md"
        >
      ...
      <nav className="flex-1 space-y-1">
        <Link
          href="/"
          className={cn(
            "rounded-lg mx-2 px-4 py-2 flex items-center gap-3 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        ...
        <div className="px-2">
          <button
            ...
            aria-expanded={open}
            className={cn(
              "w-full rounded-lg px-4 py-2 flex items-center justify-between transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
              inWorkspaces
                ? "bg-primary/[0.08] text-primary font-semibold"
                : "text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50",
            )}
          ...
          {open && (
            <div className="mt-1 ml-9 space-y-1 border-l border-outline-variant/40 pl-3">
                ...
                projects.map((p) => {
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        "py-1 text-caption flex items-center gap-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-sm",
              ...
              <Link
                ...
                className="py-1 text-primary text-caption font-semibold flex items-center gap-1 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-sm"
              >
