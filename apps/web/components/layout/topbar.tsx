    ...
    >
      <div className="flex items-center gap-8 min-w-0">
        ...
        <button
          ...
          className="relative w-72 max-w-[40vw] hidden md:flex items-center text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
