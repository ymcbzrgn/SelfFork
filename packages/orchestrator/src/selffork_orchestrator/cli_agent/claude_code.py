"""ClaudeCodeAgent — planned stub.

Implementation lands in **M2-M3** per
``project_selffork_jr_drives_3_cli_agents.md``. Until then, instantiating
...
class ClaudeCodeAgent(CLIAgent):
    ...
    def __init__(self, config: CLIAgentConfig) -> None:
        raise NotImplementedError(
            "ClaudeCodeAgent is planned for M2-M3 (see "
            "project_selffork_jr_drives_3_cli_agents.md). "
            "For MVP, set cli_agent.agent='opencode'.",
        )
