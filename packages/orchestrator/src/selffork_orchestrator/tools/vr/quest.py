...
async def _quest_app_terminate(ctx: ToolContext, args: QuestAppTerminateArgs) -> dict[str, Any]:
    ...
    return await _invoke_vr(
        ctx,
        action_type="quest.app_terminate",
        target_uri=f"quest-app:{args.package}",
        args_summary={"package": args.package},
...
async def _quest_list_vr_apps(ctx: ToolContext, args: QuestListVrAppsArgs) -> dict[str, Any]:
    ...
    return await _invoke_vr(
        ctx,
        action_type="quest.list_vr_apps",
        target_uri=None,
        args_summary={},
        coro_factory=_list,
    )
...
async def _quest_uninstall_app(ctx: ToolContext, args: QuestUninstallAppArgs) -> dict[str, Any]:
    ...
    return await _invoke_vr(
        ctx,
        action_type="quest.uninstall_app",
        target_uri=f"quest-app:{args.package}",
        args_summary={"package": args.package},
...
async def _quest_passthrough_enable(
    ctx: ToolContext,
    args: QuestPassthroughEnableArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.passthrough_enable",
        target_uri=None,
        args_summary={},
...
async def _quest_passthrough_disable(
    ctx: ToolContext,
    args: QuestPassthroughDisableArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.passthrough_disable",
        target_uri=None,
        args_summary={},
...
async def _quest_press_meta_button(
    ctx: ToolContext,
    args: QuestPressMetaButtonArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.press_meta_button",
        target_uri=None,
        args_summary={},
...
async def _quest_press_controller_button(
    ctx: ToolContext,
    args: QuestPressControllerButtonArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.press_controller_button",
        target_uri=None,
...
async def _quest_get_boundary(
    ...
    return await _invoke_vr(
        ctx,
        action_type="quest.get_boundary",
        target_uri=None,
        args_summary={},
        coro_factory=_get,
    )
...
async def _quest_record_video(
    ctx: ToolContext,
    args: QuestRecordVideoArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.record_video",
...
async def _quest_stop_record_video(
    ctx: ToolContext,
    args: QuestStopRecordVideoArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.stop_record_video",
        target_uri=None,
        args_summary={},
...
async def _quest_voice_command(
    ctx: ToolContext,
    args: QuestVoiceCommandArgs,
) -> dict[str, Any]:
    drv = _require_quest_driver(ctx)
    return await _invoke_vr(
        ctx,
        action_type="quest.voice_command",
        target_uri=None,
...
def build_quest_tools() -> list[ToolSpec[Any]]:
    return [
        ...
        ToolSpec(
            ...
            args_model=QuestScreenshotArgs,
            handler=_quest_screenshot,
            defer_loading=False,
        ),
        ToolSpec(
            name="quest_app_launch",
            description="Launch a Quest 3 VR app by package name.",
            args_model=QuestAppLaunchArgs,
            handler=_quest_app_launch,
            defer_loading=False,
        ),
        ToolSpec(
            name="quest_recenter",
            description="Recenter the Quest 3 headset view (Meta intent).",
            args_model=QuestRecenterArgs,
            handler=_quest_recenter,
            defer_loading=False,
        ),
        # Deferred (14)
        ToolSpec(
            ...
            args_model=QuestAppTerminateArgs,
            handler=_quest_app_terminate,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_app_list",
            description="List all installed Quest 3 apps.",
            args_model=QuestAppListArgs,
            handler=_quest_app_list,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_list_vr_apps",
            description=("List Quest 3 apps with VR/Meta package heuristic flag."),
            args_model=QuestListVrAppsArgs,
            handler=_quest_list_vr_apps,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_install_apk",
            description="Sideload an APK onto Quest 3 (adb install -r).",
            args_model=QuestInstallApkArgs,
            handler=_quest_install_apk,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_uninstall_app",
            description="Uninstall a Quest 3 app by package (adb uninstall).",
            args_model=QuestUninstallAppArgs,
            handler=_quest_uninstall_app,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            handler=_quest_passthrough_enable,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            handler=_quest_passthrough_disable,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            handler=_quest_press_meta_button,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            handler=_quest_press_controller_button,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            args_model=QuestGetBatteryArgs,
            handler=_quest_get_battery,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_device_info",
            description=("Read Quest model / OS / runtime version via Android getprop."),
            args_model=QuestDeviceInfoArgs,
            handler=_quest_device_info,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_get_boundary",
            description="Read Quest Guardian (boundary) status from OVRGuardian dumpsys.",
            args_model=QuestGetBoundaryArgs,
            handler=_quest_get_boundary,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_logcat",
            description=("Read Quest device logcat (Android log; optional tag filter)."),
            args_model=QuestLogcatArgs,
            handler=_quest_logcat,
            defer_loading=True,
        ),
        ToolSpec(
            name="quest_record_video",
            description="Start on-device Quest screenrecord with a time limit.",
            args_model=QuestRecordVideoArgs,
            handler=_quest_record_video,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            handler=_quest_stop_record_video,
            defer_loading=True,
        ),
        ToolSpec(
            ...
            args_model=QuestVoiceCommandArgs,
            handler=_quest_voice_command,
            defer_loading=True,
        ),
    ]
